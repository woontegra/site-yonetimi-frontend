...
export function Input({ className, invalid = false, ...props }: InputProps) {
  return (
    <input
      ...
      className={cn(
        "pointer-events-auto box-border h-control w-full min-w-0 max-w-full rounded-md border bg-surface px-2.5 text-[13px] font-normal tracking-normal text-ink placeholder:text-muted/80",
